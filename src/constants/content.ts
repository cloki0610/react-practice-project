...
const experiences = [
  ...
  },
  {
    ...
    date: "July 2024 - Now",
    points: [
      "Developing and maintaining web applications using React, Next.js other related libraries and packages.",
      "Collaborating with back-end, mobile team and designer to create high-quality products.",
      "Provide manual testing, unit test and end to end testing with complete report to reveal problems.",
      "Participate daily trouble shooting, content update, and Database / AWS / Google Platform administration",
      "Participating in code reviews, share knowledge and providing constructive feedback to other developers.",
    ],
  },
];
